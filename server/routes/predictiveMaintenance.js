...
// Predictive maintenance flagging vehicles by age/mileage/condition
...
router.get('/info', auth, (req, res) => {
  res.json({ feature: 'predictive-maintenance', title: 'Predictive maintenance flagging vehicles by age/mileage/condition', project: 'AIVehicleInspectionCertification' });
});
